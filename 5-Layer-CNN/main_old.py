...
# Run with HSA_OVERRIDE_GFX_VERSION=10.3.0 /bin/python3 /home/potatosalad/project/pj_ML/main.py
...
parser.add_argument('--batch_size', default=128, type=int,
                    help='batch size')
parser.add_argument('--model', default="mcnn", type=str,
                    help='specify model name')
parser.add_argument('--optimizer', default="adam", type=str,
                    help='specify optimizer')
parser.add_argument('--noise', default=10.0, type=float,
