...
width_params = [1, 2, 8, 16, 32, 64]
data_paths = [f"mcnn_cifar10_adam/noise-0.0_datasize-1.0_w_param-{p}/history.pth" for p in width_params]
...
plt.title('Test Error vs CNN Width')
plt.legend()
plt.show()